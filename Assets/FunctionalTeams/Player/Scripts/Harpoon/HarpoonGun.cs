...
public class HarpoonGun : MonoBehaviour
{
    ...
    [SerializeField] private bool _doesHarpoonRemainsInHitObject;
    ...
    private void CreateInitialHarpoonPool()
    {
        ...
        for(int i = 0; i < _harpoonPoolingAmount; i++)
        {
            ...
            HarpoonProjectileMovement newestHarpoon = 
                Instantiate(_harpoonPrefab, _playerLookDirection.position, Quaternion.identity)
                .GetComponent<HarpoonProjectileMovement>();
    ...
    public bool GetDoesHarpoonRemainsInObject() => _doesHarpoonRemainsInHitObject;
